 ...
 * 
 * This class is part of the Supplier Service in the microservices architecture, responsible for managing suppliers and 
 * their information. It interacts with the Project Service for supplier allocation. 
 * 
 * Responsibilities: 
 * - Manage suppliers and their information. 
 * - Provide supplier data to Project service for supplier selection and management. 
 * 
 * Data Ownership: 
 * - Supplier details and contracts. 
 * 
 * Interactions: 
 * - Interfaces with Project service for supplier allocation. 
 * 
 * Scalability: 
 * - Designed to be independently deployable, with its own database to ensure data encapsulation. 
 * - Communicates through RESTful APIs, ensuring stateless interactions and easy scalability. 
 * 
 ...
 * 
 * @see com.asdvconstruction.portal.service.SupplierDAO 
 * @see com.asdvconstruction.portal.model.Supplier 
 * @see com.asdvconstruction.portal.controller.ProjectBean 
 * 
